...
from memory_layer.exceptions import ConfigurationError, StorageError
from memory_layer.models import MemoryChunk, MemoryType
from memory_layer.storage.base import MemorySearchQuery, VectorStoreBackend
...
class ChromaAdapter(VectorStoreBackend):
    ...
    def __init__(
        ...
        *,
        chroma_path: str,
        collection_name: str = "memory_layer",
        ...
        if self._client is None:
            try:
                ...
                raise ConfigurationError(
                    "ChromaAdapter requires chromadb. Install memory-layer-ai[storage]."
                ) from exc
